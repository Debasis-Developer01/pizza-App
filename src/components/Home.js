	...
	return (
		...
		>
							...
							<ul className='navigation-list'>
								...
								{localStorage.getItem("role") === "[customer]" && (
									<>
										...
										<button
											className='yellow'
											onClick={() => navigate("/addCustomerDetails")}
										>
											Profile
										</button>
									</>
			...
			<Routes>
				...
				<Route
					path='/adminupdateorders'
					element={<AdminUpadateOrders />}
				></Route>
				<Route
					path='/adminupdateorderstatus'
					element={<AdminUpdateOrderStatus />}
				></Route>
